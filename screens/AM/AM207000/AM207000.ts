...
@graphInfo({graphType: "PX.Objects.AM.WCMaint", primaryView: "WCRecords", showUDFIndicator: true})
export class AM207000 extends PXScreen {
	...
	@viewInfo({ containerName: "Substitutes" })
	SubstituteWorkCenters = createCollection(AMWCSubstitute);
	@viewInfo({ containerName: "Operation Mass Update" })
	MassUpdateFilter = createSingle(WorkCenterUpdateFilter);
	@viewInfo({ containerName: "Calculated Calendar" })
