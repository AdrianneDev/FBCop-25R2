import { PXView, PXFieldState, gridConfig, linkCommand, columnConfig, PXActionState, createCollection, PXScreen, graphInfo, GridPreset, GridColumnDisplayMode } from "client-controls";

@graphInfo({
	graphType: "PX.Objects.AP.APDocumentRelease", primaryView: "APDocumentList",
...
export class APRegister extends PXView {
	...
	@columnConfig({ allowUpdate: false, hideViewLink: true, displayMode: GridColumnDisplayMode.Both })
