...
@graphInfo({ graphType: "PX.Objects.AM.ECOMaint", primaryView: "Documents", showActivitiesIndicator: true, showUDFIndicator: true })
export class AM215000 extends PXScreen {
	@viewInfo({ containerName: "ECO" })
	...
	getAMBomOperRowCss(args: RowCssHandlerArgs) {
		return AM215000.getRowCss(args);
	}
