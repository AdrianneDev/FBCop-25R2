import {
	...
	PXFieldOptions, PXPageLoadBehavior, GridColumnShowHideMode, GridPreset
...
export class CABankTranHistory extends PXView {
	...
	@columnConfig({textField: "RuleID_CABankTranRule_Description"})
	RuleID: PXFieldState;
	...
	MatchedReferenceCD: PXFieldState;
	MatchedReferenceName: PXFieldState;
