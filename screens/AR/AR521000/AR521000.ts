import {
	...
	PXFieldOptions, GridColumnType, GridPreset
...
export class ARDunningLetterRecordsParameters extends PXView {
	...
	AddUnpaidPPI: PXFieldState<PXFieldOptions.NoLabel | PXFieldOptions.CommitChanges>;
...
export class ARDunningLetterList extends PXView {
	@columnConfig({ allowSort: false, allowNull: false, type: GridColumnType.CheckBox, allowCheckAll: true })
