...
export class FS202001 extends PXScreen {
	...
	@viewInfo({ containerName: "Recurrence"})
	StaffScheduleSelected = createSingle(FSStaffScheduleSelected);
}
...
export class FSStaffSchedule extends PXView {
	...
	StartTime_Time: PXFieldState<PXFieldOptions.CommitChanges>;
	EndTime_Time: PXFieldState<PXFieldOptions.CommitChanges>;
...
export class FSStaffScheduleSelected extends PXView {
	FrequencyType: PXFieldState<PXFieldOptions.CommitChanges>;
	RecurrenceDescription: PXFieldState<PXFieldOptions.Readonly>;
