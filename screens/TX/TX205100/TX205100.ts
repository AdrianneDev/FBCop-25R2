import {
	createCollection, createSingle, PXScreen, graphInfo, PXView, PXFieldState, gridConfig, PXFieldOptions, columnConfig, GridColumnShowHideMode, PXActionState, GridPreset
...
@gridConfig({ preset: GridPreset.Details, initNewRow: true, keepPosition: true })
