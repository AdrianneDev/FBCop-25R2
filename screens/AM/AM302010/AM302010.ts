...
@graphInfo({ graphType: "PX.Objects.AM.ScanMove+Host", primaryView: "HeaderView", hideFilesIndicator: true, hideNotesIndicator: true, showUDFIndicator: true })
export class AM302010 extends BarcodeProcessingScreen {
