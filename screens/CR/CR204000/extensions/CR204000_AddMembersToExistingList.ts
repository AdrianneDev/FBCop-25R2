...
export interface CR204000_AddMembersToExistingList extends CR204000 {}
export class CR204000_AddMembersToExistingList {
	AddMembersToExistingListsFilterView = createCollection(CRMarketingListAlias2);
}
...
export class CRMarketingListAlias2 extends PXView {
