...
export interface CR304500_QuickEstimate extends CR304500 {}
export class CR304500_QuickEstimate {
	@viewInfo({ containerName: "Dialog: Quick Estimate" })
...
export class AMEstimateItem2 extends PXView {
	...
	HasPriceBreak: PXFieldState<PXFieldOptions.CommitChanges>;
	UOM: PXFieldState;
