...
@graphInfo({ graphType: "PX.Objects.PM.PMQuoteProcess", primaryView: "Filter" })
export class PM504545 extends PXScreen {
	Filter = createSingle(PrintQuotesFilter);
	Records = createCollection(PMQuote);
}
...
export class PMQuote extends PXView {
	...
	GrossMarginAmount: PXFieldState;
