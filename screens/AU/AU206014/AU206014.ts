...
@graphInfo({graphType: "PX.SM.ProjectDashboardsV2Maintenance", primaryView: "Items", hideNotesIndicator: true, hideFilesIndicator: true })
export class AU206014 extends AuBaseScreen {
	Items = createCollection(CustObject);

   	@viewInfo({containerName: "Dashboards"})
	ViewSelectDasboards = createCollection(DashboardV2);
}
