...
export class SM204007 extends PXScreen {
	...
	@handleEvent(CustomEventType.RowSelected, { view: "ActionExecutionParameters" })
	onFieldValueRowSelected(args: RowSelectedHandlerArgs<PXViewCollection<ActionExecutionParameter>>) {
