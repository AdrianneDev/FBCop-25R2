...
export class SM201060 extends PXScreen {
	...
	@viewInfo({ containerName: "Email Settings" })
	PrefsEmail = createSingle(PreferencesEmail);
}
...
export class PreferencesEmail extends PXView {
	UserWelcomeNotificationId: PXFieldState;
	PortalUserWelcomeNotificationId: PXFieldState;
	...
	PortalPasswordRecoveryNotificationId: PXFieldState;
