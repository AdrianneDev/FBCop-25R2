...
export class StepSettings extends PXView {
	...
	CostCodeOrigin: PXFieldState<PXFieldOptions.CommitChanges>;
	...
	OffsetCostCodeOrigin: PXFieldState<PXFieldOptions.CommitChanges>;
	...
	OffsetCostCodeID: PXFieldState<PXFieldOptions.CommitChanges>;
