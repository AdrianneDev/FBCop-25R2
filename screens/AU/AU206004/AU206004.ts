...
@graphInfo({graphType: "PX.SM.ProjectDashboardsMaintenance", primaryView: "Items", hideNotesIndicator: true, hideFilesIndicator: true })
export class AU206004 extends AuBaseScreen {
	Items = createCollection(CustObject);

   	@viewInfo({containerName: "Dashboards"})
	ViewSelectDasboards = createCollection(Dashboard);
}
...
export class Dashboard extends PXView  {
	...
	@columnConfig({width: 300})	ScreenID: PXFieldState;
}
