import { PXView, PXFieldState, gridConfig, PXFieldOptions, columnConfig, GridColumnShowHideMode, GridColumnType, PXActionState, TextAlign, GridPreset, actionConfig, GridColumnDisplayMode } from "client-controls";
...
export class PMTimeActivity extends PXView {
	@actionConfig({ text: "Show All Workgroup Members" })
	...
	@columnConfig({ width: 200, hideViewLink: true })
