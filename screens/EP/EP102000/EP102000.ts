import { createCollection, PXScreen, graphInfo, PXActionState, ServerCommand } from "client-controls";
...
export class EP102000 extends PXScreen {
	...
	async attached() {
		...
		if (payrollFeatureSet["PX.Objects.CS.FeaturesSet"]?.PayrollModule) {
			...
			await this.screenService.executeCommand(new ServerCommand("RedirectToPayrollScreen"));
			return;
		}
