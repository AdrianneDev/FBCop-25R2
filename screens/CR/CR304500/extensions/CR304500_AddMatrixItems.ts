...
import { AddMatrixItemsBase, EntryMatrix } from "src/screens/IN/common/matrix-items/panel-add-matrix-items/panel-add-matrix-items";
import { CR304500 } from "../CR304500";
import { MatrixGridManager } from "src/screens/IN/common/matrix-items/matrix-grid-manager";

export interface CR304500_AddMatrixItems extends CR304500, AddMatrixItemsBase { }
export class CR304500_AddMatrixItems extends AddMatrixItemsBase {
