...
@graphInfo({
	graphType: "PX.Objects.FS.ServiceContractEntry",
	primaryView: "ServiceContractRecords",
	showUDFIndicator: true,
	showActivitiesIndicator: true,
	bpEventsIndicator: true
})
export class FS305700 extends PXScreen {
	OpenScheduleScreen: PXActionState;
	ActivatePeriod: PXActionState;
	OpenScheduleScreenByScheduleDetService: PXActionState;
	OpenScheduleScreenByScheduleDetPart: PXActionState;
	FSBillHistory$ChildDocLink$Link: PXActionState;
	openPostBatch: PXActionState;

	@viewInfo({ containerName: "Service Contract" })
...
export class FSContractAction extends PXView {
	...
	OrigScheduleRefNbr: PXFieldState;
}
